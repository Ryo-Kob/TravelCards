...
class PlanRecyclerItemClickListener(context: Context, recyclerView: RecyclerView, private val listener: PlanRecyclerItemClickListener.OnRecyclerClickListener)
